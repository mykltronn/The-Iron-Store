  ...
  if(this.state.currentPage == "Admin Master Page"){
    ...
    return(
      <div className="adminDiv">
        <input className="adminInputButton" type="button" value="X" />
        <h5 className="adminH5">Are you sure you want to delete this product</h5>
        <form className="adminForm">
          <button className="adminButton" type="submit">Yes</button>
